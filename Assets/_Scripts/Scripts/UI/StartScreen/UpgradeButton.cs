...
public class UpgradeButton : MonoBehaviour
{
    ...
    [SerializeField] private GameObject _buyWithMoneyVisual;
    [SerializeField] private GameObject _buyWithAdVisual;
    ...
    private void Start()
    {
        ...
        _mainButton.onClick.AddListener(OnUpgradeButtonClick);
    }
    ...
    private void OnDestroy()
    {
        ...
        _mainButton.onClick.RemoveListener(OnUpgradeButtonClick);
    }
    ...
    private void ChangeButtonState(bool state)
    {
        ...
        _buyWithMoneyVisual.gameObject.SetActive(state);
        _buyWithAdVisual.gameObject.SetActive(!state);
    }

    private void OnUpgradeButtonClick()
    {
        if (_buyWithAdVisual.activeSelf)
        {
            OnUpgradeWithAdButtonClick();
            return;
        }
        if (!CanBeUpgraded())
            return;
